# AI Workflows — Report Index

Auto-generated index of all video reports. Use this to find the right report when planning a workflow.
...
- **[Hermes Agent — 7 Use Cases](reports/hermes-agent-7-use-cases.md)** — Cron-based daily brief, iMessage/WeChat management, DevOps automation. *Intermediate / agent-loop*
...
- **[Claude Routines](reports/claude-routines-scheduled-agents.md)** — PostHog → product brief → Claude Code action plan; Stripe → revenue pulse. *Beginner / automated-pipeline*
...
|--------|--------------|
| [Claude Video Editing](reports/claude-video-editing-hyperframes.md) | Natural language → edited video |
...
**agent-infrastructure**: hermes-agent-7-use-cases, hermes-agent-v012-self-maintaining, greg-isenberg-ai-agents-run-business

**automation**: hermes-agent-7-use-cases, claude-routines-scheduled-agents, greg-isenberg-ai-agents-run-business

**vibe-coding**: open-design-vibe-coding-ui, codex-best-software-ever
...
**self-improvement**: hermes-agent-v012-self-maintaining

**brand-identity**: claude-higgsfield-mcp-marketing

**ugc-video**: claude-higgsfield-mcp-marketing

**analytics**: greg-isenberg-ai-agents-run-business, claude-routines-scheduled-agents

**vector-database**: greg-isenberg-ai-agents-run-business
...
| 2026-05-04 | [Open Design](reports/open-design-vibe-coding-ui.md) | Sean Kochel | Beginner |
| 2026-05-04 | [Hermes Agent v0.12](reports/hermes-agent-v012-self-maintaining.md) | Panda Making Money | Advanced |
| 2026-05-04 | [AI Agents Run My Business](reports/greg-isenberg-ai-agents-run-business.md) | Greg Isenberg | Advanced |
| 2026-05-04 | [Claude Routines](reports/claude-routines-scheduled-agents.md) | (Claude Routines demo) | Beginner |
| 2026-05-04 | [Claude + Higgsfield MCP](reports/claude-higgsfield-mcp-marketing.md) | ambITious \| AI | Intermediate |
